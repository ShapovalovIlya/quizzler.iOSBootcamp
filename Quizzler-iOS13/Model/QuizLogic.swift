...
struct QuizLogic {
    ...
    //Created method to check user's answer. Was it True or False
    mutating func checkAnswer(_ userAnswer: Int) -> Bool {
        let userAnswer = quiz[questionNumber].answer[userAnswer]
    ...
    //Created method to get answer title for buttons
    func getAnswerText(for buttonTag: Int) -> String {
        return quiz[questionNumber].answer[buttonTag]
    }
    
    //Created method to get text for question label
    ...
    //Created method for tracking progress
    ...
    //Created methot for tracking user score
    func getScore() -> Int {
        return score
    }
